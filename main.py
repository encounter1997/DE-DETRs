...
def get_args_parser():
    ...
    # repeat label
    parser.add_argument('--repeat_label', type=int, default=None, help="repeat the foreground labels for n times")
    parser.add_argument('--repeat_ratio', type=float, default=None, help="resample GTs to make fore:all=ratio, 1/4")
